...
function carregarMenu() {
    try {
        ...
        const svgs = {
            ...
            comp: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.358c0-.859-.46-1.646-1.2-2.02l-1.954-1.025a3.5 3.5 0 01-1.748-1.905l-.6-1.636a3.5 3.5 0 00-3.33-2.39h-1.336c-1.385 0-2.607.828-3.13 2.112l-1.01 2.443a3.5 3.5 0 01-1.626 1.868L2.4 13.41c-.74.374-1.2 1.16-1.2 2.02v3.32m7.5-3v-4.5m3 4.5v-4.5" /></svg>`,
